...
pub async fn get_list_objects(_client_id: Option<String>, _container_id: Option<String>, _container_type: Option<String>, _table_name: Option<String>, _column_name: Option<String>, _record_id: Option<String>, _user_id: Option<String>) -> Result<ResourceResponse, std::io::Error> {
...
// pub async fn ge_objects_list(_folder_name: String, _method: Method, _seconds: Option<u32>) -> Result<String, std::io::Error> {
//     let _s3_url =  match env::var("S3_URL") {
//         Ok(value) => value,
//         Err(_) => {
//             log::info!("Variable `S3_URL` Not found");
